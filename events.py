    ...
    def handle_disconnect():
        ...
        for room_code, room_data in rooms.items():
            if request.sid in room_data['players']:
                ...
                # Notify others that a player has left/disconnected
                emit('player_left_gameroom', {'sid': request.sid}, to=room_code)
                
                # Only reset to 'waiting' if we were NOT playing
                # This allows refreshing the page without killing the game
